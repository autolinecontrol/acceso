<?php error_reporting(E_ALL & ~E_DEPRECATED & ~E_STRICT & ~E_WARNING & ~E_NOTICE);?>
...
function comprobarf($ingreso,$salida){ 
   //compruebo que el tamaño del string sea válido. 
    ...
    {
         $fechamax= date("Y-m-d",strtotime($ingreso."+ 15 days"));
         if ($salida>$fechamax) {
...
$idautoriza='';
            $grupo='1';
$sql="replace INTO visitantes (idvisitante,nombre,identificacion,codigo,Oficina,correo,Ingreso,Salida,estado,ncontroladora,tipo,vehiculo,grupo) VALUES ('', '$nombre1', '$cedula1', '$codigo', '$oficina1','$correo1','$ingreso','$salida','$stat','$cont','$tipo','$carro','$grupo')";
          ...
          $resultado = mysqli_query($con, "replace INTO logregistros(Administrador,idVisitante,idAutoriza,Oficina,Fechainicio,Fechafin,Tipo,Accion) VALUES ('$admin', '$cedula1', '$anfitrion','$oficina1','$ingreso','$salida','$tipo','$accion')"); 
          echo "<tr>";
