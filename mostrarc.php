	   ...
	   <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
        ...
        <script type="text/javascript">
            ...
            function mostrarUsuarios()
            {
                ...
                xmlhttp.open("GET","servidorc.php?personas=" + "personas", true)
            ...
            function actualizarUsuario(usuarioID)
            {
                ...
                xmlhttp.open("GET","servidorc.php?usuarioIDActualizado="+ usuarioID + "&ingresoActualizado=" + ingresoActualizado + "&salidaActualizado=" + salidaActualizado, true);
                xmlhttp.send();
            ...
            function borrarUsuario(usuarioID)
            {
                ...
                if(respuesta===true)
                {
                    ...
                    xmlhttp.open("GET","servidorc.php?usuarioIDEliminado="+usuarioID);
                    xmlhttp.send();
                }
            }
            ...
            function agregarUsuario()
            {
                ...
                xmlhttp.open("GET","servidorc.php?personas=" + "personas"+
