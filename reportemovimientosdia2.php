...
if(isset($_POST['buscador']))
{
    for($l=1;$l<=30;$l++)
    {
    echo "Fecha ".$nuevoIngreso."<br>";
    //echo $nuevoIngreso;
    $m=$l+1;
    $nuevoIngreso="2019-10-$l";
    $nuevoSalida="2019-10-$m";
    for($i=1;$i<=11;$i++)
    {
        
        $sql="SELECT COUNT(DISTINCT t1.identificacion) as cnt from transacciones as t1,visitantes as t2 where t1.Ingreso >= '$nuevoIngreso' and t1.Ingreso <= '$nuevoSalida' ";
        //. " and transacciones.oficina = '$nuevaofice'"
        //. "order by transacciones.Ingreso";
        $sql=$sql." and t1.oficina = '$i'";
        $sql=$sql." and t2.tipo = 'VISITANTE' ";
        //echo $i;
