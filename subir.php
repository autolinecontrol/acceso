...
<head>
	...
	<script src="bootstrap/js/bootstrap.min.js"></script>
       ...
       <title>Subida de Masivos FUNCIONARIOS</title>
...
<a href="http://centralpointacceso.com/acceso/LOGIN/mostrar.php">Mostrar</a>
<br>
...
if (isset($_FILES["archivo"]) && is_uploaded_file($_FILES['archivo']['tmp_name'])) {
 ...
 $nombre = $nombre." ".$nombre1;
  ...
  if($valido > 1 && $cedula != '') 
      ...
      if($nombre != '')
         {
          $resultado = mysqli_query($con, "replace INTO visitantes (idvisitante,nombre,identificacion,codigo,Oficina,correo,Ingreso,Salida,estado,ncontroladora,tipo,vehiculo) VALUES ('', '$nombre1', '$cedula1', '$codigo', '$oficina1','$correo1','$ingreso','$salida','$stat','$cont','$tipo','$carro')");
          ...
          $resultado = mysqli_query($con, "replace INTO Log(Administrador,idVisitante,idAutoriza,Oficina,Fechainicio,Fechafin,Tipo,Accion) VALUES ('$admin', '$cedula1', '$anfitrion','$oficina1','$ingreso','$salida','$tipo','$accion')"); 
          echo "<tr>";
