...
<html lang="en" class="no-js">
	...
	<link href="StyleSheet.css" rel="stylesheet" />
       ...
       <title>Mostrar Visitantes</title>
	   ...
	   <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
        ...
        <script type="text/javascript">
            ...
            function actualizarUsuario(usuarioID)
            {
                ...
                xmlhttp.open("GET","servidor.php?usuarioIDActualizado="+ usuarioID + "&ingresoActualizado=" + ingresoActualizado + "&salidaActualizado=" + salidaActualizado, true);
                xmlhttp.send();
            ...
            function agregarUsuario()
            {
                ...
                xmlhttp.open("GET","servidor.php?nuevoUsuario="+nuevoUsuario+"&nuevoEmail="+nuevoEmail+"&nuevaIdentificacion="+nuevaIdentificacion+
