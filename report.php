 ...
 <body>
            ...
            <div class="header-second-bar">
                    ...
                    <form class="contact_form" id="buscador" name="buscador" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>"> 
                        <input id="busca" name="ingreso" type="datetime-local" placeholder="Entrada" autofocus >
                        <input id="busca" name="salida" type="datetime-local" placeholder="Salida" autofocus >
