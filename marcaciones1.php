...
<?php  
    $resultado = mysqli_query($con, "select visitantes.identificacion, visitantes.nombre "
	...
	. " and visitantes.Oficina = '$nuevaofice'"
   ...
   // echo $cc.'<br>';
    ...
    while($fila = mysqli_fetch_assoc($resultado1))
    {
	    ...
	    echo '<td>' . $name    . '</td>';
            ...
            echo '</tr>';
            //echo 'Cedula Ingreso '.$Cedula1.' Fecha ingreso '. $Fechamenor.' Fecha Salida '. $Fechamayor.'<br>'.'<br>';
            $Fecha1=$Fecha2;
            $h1=$h2;
            $Fechamenor=$fila['Ingreso'];
        }
	//echo 'id1 '.$Cedula1.' id2 '.$Cedula2.'<br>';
